...
- Deprecates `fill_form/3` and `submit_form/3`.
...
- encourages us (me included!) to use labels correctly in forms,
- decouples our forms from the shape of a changeset or Phoenix form --
something that's a mere implementation detail, and
- allows us to express our tests more like our users would when seeing a page
