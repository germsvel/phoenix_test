...
if (
  ...
  ![undefined, "checkbox_checked", "checkbox_unchecked", "roles"].includes(interaction)
) {
  throw new Error("Usage: node browser.mjs live|static RUN_ID [checkbox_checked|checkbox_unchecked|roles]");
}
